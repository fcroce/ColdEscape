import{$ as r}from"./index-ySfS2gYj.js";const e="spritesVertexShader",t=`attribute position: vec4f;attribute options: vec2f;attribute offsets: vec2f;attribute inverts: vec2f;attribute cellInfo: vec4f;attribute color: vec4f;uniform view: mat4x4f;uniform projection: mat4x4f;varying vUV: vec2f;varying vColor: vec4f;
...
}`;r.ShadersStoreWGSL[e]=t;const n={name:e,shader:t};export{n as spritesVertexShaderWGSL};
