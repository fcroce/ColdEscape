import{$ as e}from"./index-Curn0qvy.js";const f="imageProcessingCompatibility",t=`#ifdef IMAGEPROCESSINGPOSTPROCESS
fragmentOutputs.color=vec4f(pow(fragmentOutputs.color.rgb, vec3f(2.2)),fragmentOutputs.color.a);
#endif
`;e.IncludesShadersStoreWGSL[f]=t;const r="spritesPixelShader",a=`uniform alphaTest: i32;varying vColor: vec4f;varying vUV: vec2f;var diffuseSamplerSampler: sampler;var diffuseSampler: texture_2d<f32>;
...
}`;e.ShadersStoreWGSL[r]=a;const n={name:r,shader:a};export{n as spritesPixelShaderWGSL};
