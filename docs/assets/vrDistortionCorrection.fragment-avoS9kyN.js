import{$ as t}from"./index-CWTGLy4c.js";const r="vrDistortionCorrectionPixelShader",e=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;t.ShadersStoreWGSL[r]=e;const n={name:r,shader:e};export{n as vrDistortionCorrectionPixelShaderWGSL};
